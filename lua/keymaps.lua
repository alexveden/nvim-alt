...
vim.keymap.set({'n'}, '<Leader>rR', '<cmd>ReplClose<cr><cmd>Repl<cr>', { silent = true, noremap = true, desc = "REPL [R]estart"  })
vim.keymap.set({'n'}, '<Leader>rC', '<cmd>ReplClose<cr>', { silent = true, noremap = true, desc = "REPL [C]lose"  })
